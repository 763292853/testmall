<template>
  <tab-bar>
    ...
    <tab-bar-item path="/cart" activeColor="red">
      ...
      <img
        slot="item-icon-active"
        src="~assets/img/tabbar/cart1.png"
        alt=""
      />
      <div slot="item-text">购物车</div></tab-bar-item
    ><tab-bar-item path="/fenlei" activeColor="red">
      <img slot="item-icon" src="~assets/img/tabbar/fenlei.png" alt="" />
      <img
        slot="item-icon-active"
        src="~assets/img/tabbar/fenlei1.png"
        alt=""
      />
    ...
    <tab-bar-item path="/me" activeColor="red">
      ...
      <img slot="item-icon-active" src="~assets/img/tabbar/me1.png" alt="" />
